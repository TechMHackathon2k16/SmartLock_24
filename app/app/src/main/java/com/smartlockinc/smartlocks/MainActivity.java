...
*/
    ...
    public void unlockbuttonOnClick(View v1) {
        ...
        if (session.checklogin() == true) {
            ...
            JsonObjectRequest postReq = new JsonObjectRequest(Request.Method.POST, "http://192.168.43.147:5000/smartlock/unlock/action", jsonObject, new Response.Listener<JSONObject>() {
    ...
    public void lockbuttonOnClick(View v1) {
        ...
        if (session.checklogin() == true) {
            ...
            JsonObjectRequest postReq = new JsonObjectRequest(Request.Method.POST, "http://192.168.43.147:5000/smartlock/lock/action", jsonObject, new Response.Listener<JSONObject>() {
